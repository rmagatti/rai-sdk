...
A highly idiomatic, pure-Rust implementation of an AI gateway SDK inspired by the Vercel AI SDK. Designed for robust backends, it features enum-based static dispatch, stateful typed API wrappers, strict typestate builders, fallible tool schemas, and automatic tool execution loops.
